...
```bash
python .claude/complexities/12_data_flow_complexity.py TREE.json
python .claude/complexities/12_data_flow_complexity.py TREE.json -o report.json
cat TREE.json | python .claude/complexities/12_data_flow_complexity.py
python .claude/complexities/12_data_flow_complexity.py --spec
```
